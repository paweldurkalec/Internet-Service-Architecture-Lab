...
function update_company(){
		...
		xhttp.open("PUT", "http://localhost:8001/api/companies/"+company_name, true);
		xhttp.setRequestHeader("Content-type", "application/json");
		console.log(JSON.stringify(company));
		xhttp.send(JSON.stringify(company));
		window.location.href = 'http://localhost:8000/views/update_company.html?company=' + company_name;
}